...
/**
 * The RecyclingUtils facilitates reuse of views across layouts. The RecyclingUtils has two levels of
...
public class RecyclingUtils {
	...
	public static View retrieveFromScrap(SparseArray<View> scrapViews, int position) {
